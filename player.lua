...
function Player:loadAssets()
    ...
    for i = 1, self.animation.air.total do
        self.animation.air.img[i] = love.graphics.newImage("assets/player/jump/" .. i .. ".png")
    end
...
function Player:draw()
    ...
    love.graphics.draw(self.animation.draw, self.x, self.y, 0, scaleX, 1, self.animation.width / 2, self.animation.height / 2 + 6.5)
end
